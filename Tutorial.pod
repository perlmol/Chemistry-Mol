...
Perl that you want to C<use> the specified modules, and that you want to import
the C<read_mol> subroutine. The third line reads the file and returns a Mol
object.
